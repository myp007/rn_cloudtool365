...
const ScrollableTabView = React.createClass({
    ...
    render() {
        ...
        if (this.props.tabBarDirection) {
            tabBarProps.tabBarDirection = this.props.tabBarDirection;
        }
        if (this.props.tabBarStyle) {
            tabBarProps.tabBarStyle = this.props.tabBarStyle;
        }
        if (this.props.tabBarItemStyle) {
            tabBarProps.tabBarItemStyle = this.props.tabBarItemStyle;
        }
        tabBarProps.tabBarBisect = this.props.tabBarBisect;
        if (overlayTabs) {
            tabBarProps.style = {
                position: 'absolute',
                left: 0,
        ...
        return <View
            style={[this.props.tabBarDirection == 'column' ? styles.containerColumn : styles.container, this.props.style]}
